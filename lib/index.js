...
const hxdec = {
        ...
        sections.forEach(section => {
            ...
            if (target_section) {
                ...
                cardCodes.forEach(code => {
                    ...
                    const newCard = { name: "", qty, set, hx_set: setHx, collector_number: number, hx_collector_number: numberHx, foil, tags, category, target_section };
                    cards.push(newCard);
                });
    ...
    getMissingCardData: (listData, opt, callback) => {
        ...
        if (incompleteCards.length > 0) {
            ...
            hxdec.getCardData(incompleteCards, updateProps, (cards) => {
                cards.forEach((card) => {
                    var _a;
