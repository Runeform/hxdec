...
const hxdec = {
        ...
        sections.forEach(section => {
            ...
            if (targetSection) {
                ...
                cardCodes.forEach(code => {
                    ...
                    const newCard = { name: "", qty, set, collector_number: number, foil, tags, category, targetSection, isComplete: false };
                    cards.push(newCard);
                });
    ...
    digestCard: (line) => {
        ...
        if (newCard.set.length > 0) {
            newCard.hxset = ((_a = hxdec.setData.find(s => s.code.toLowerCase() === newCard.set.toLowerCase())) === null || _a === void 0 ? void 0 : _a.hxset) || null;
        }
            ...
            hxdec.getCardData(incompleteCards, ["name", "set", "collector_number"], (cards) => {
                cards.forEach((card) => {
                    ...
                    if (card.set.length > 0 && card.collector_number.length > 0 && hxdec.setData.length > 0) {
                        card.hxset = ((_a = hxdec.setData.find(s => s.code.toLowerCase() === card.set.toLowerCase())) === null || _a === void 0 ? void 0 : _a.hxset) || null;
